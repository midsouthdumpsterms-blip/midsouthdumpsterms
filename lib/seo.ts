 ...
 * gets cropped into the small thumbnail treatment instead.
 *
 * It is now a genuine 1200x630 JPEG, generated by scripts/build-og-image.ps1
 * from public/images/brand-card-square.png. Regenerate with that script rather
 * than resizing the square art by hand - the phone number and URL sit at the
 * bottom of the square card and a 1.91:1 crop cuts them off.
 */
