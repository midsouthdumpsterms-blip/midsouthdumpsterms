...
export const metadata: Metadata = {
    ...
    title: 'Dumpster Rental Pelahatchie MS | Same-Day',
    description:
        'Roll-off dumpster rental in Pelahatchie, MS from $349. 10, 15 and 20-yard containers, same-day delivery to Pelahatchie and eastern Rankin County.',
    openGraph: {
        ...
        <>
            ...
            <section>
                <div className="container">
                    ...
                    <PriceSummary place="Pelahatchie" />
                </div>
            </section>
