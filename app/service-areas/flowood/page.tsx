...
export const metadata: Metadata = {
    ...
    title: 'Dumpster Rental Flowood MS | Same-Day',
    description:
        'Roll-off dumpster rental in Flowood, MS from $349. 10, 15 and 20-yard containers, same-day delivery to Kensington, Laurelwood and Lakeland Drive.',
    openGraph: {
