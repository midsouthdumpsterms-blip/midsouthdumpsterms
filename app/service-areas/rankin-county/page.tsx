...
export const metadata: Metadata = {
    ...
    title: 'Dumpster Rental Rankin County MS',
    description:
        'Roll-off dumpster rental throughout Rankin County, Mississippi. 10, 15 and 20-yard containers, same-day delivery, flat rates from $349.',
    openGraph: {
        title: 'Roll Off Dumpster Rental Rankin County MS',
