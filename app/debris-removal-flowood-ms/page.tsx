...
export default function DebrisRemovalFlowoodPage() {
    const serviceSchema = generateServiceSchema('Debris Removal', 'Debris removal service in Flowood, MS via roll-off dumpster rental. We deliver a container, you fill it, we haul it away.', 'Flowood, MS')
    const breadcrumbSchema = generateBreadcrumbSchema([
        { name: 'Home', url: 'https://midsouthdumpsterms.com' },
        { name: 'Debris Removal Flowood MS', url: 'https://midsouthdumpsterms.com/debris-removal-flowood-ms' },
    ])
    ...
    return (
        <>
            ...
            <section style={{ padding: 'var(--spacing-2xl) 0' }}>
                <div className="container">
                    <div className="grid grid-2">
                        <div>
                            <h2>Debris Removal in Flowood, Mississippi</h2>
            ...
            <section style={{ background: 'var(--color-gray-50)', padding: 'var(--spacing-2xl) 0' }}>
                <div className="container">
                    <h2 className="text-center">Debris Removal Pricing in Flowood, MS</h2>
            ...
            <section style={{ padding: 'var(--spacing-2xl) 0' }}>
                <div className="container">
                    <p style={{ color: 'var(--color-gray-600)' }}>
                        Flowood is located in <Link href="/service-areas/rankin-county" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}></Link>. Also see our <Link href="/service-areas/flowood" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}> dumpster rental page</Link> and <Link href="/waste-disposal-flowood-ms" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}>waste disposal in Flowood</Link>.
                    </p>
