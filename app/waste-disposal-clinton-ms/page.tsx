            ...
            <section style={{ background: 'linear-gradient(135deg, var(--color-secondary) 0%, var(--color-primary) 100%)', color: 'white', padding: '4rem 0', textAlign: 'center' }}>
                <div className="container">
                    ...
                    <p style={{ fontSize: '1.2rem', opacity: 0.92, maxWidth: '640px', margin: '0 auto 2rem' }}>
                        Convenient, affordable waste disposal for Clinton residents and businesses — we handle transportation and proper disposal so you don't have to
                    </p>
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        <BookingButton label="Book Online" location="Waste Disposal Clinton Hero" />
                        <TrackedPhoneLink location="Waste Disposal Clinton Hero" className="btn btn-outline-white btn-lg">Call 601-316-7891</TrackedPhoneLink>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-2">
                        <div>
                            ...
                            <p style={{ color: 'var(--color-gray-600)' }}>
                                Mid South Dumpster Rentals makes waste disposal in Clinton, Mississippi simple and affordable. We serve downtown Clinton, Traceland, and Northside and all surrounding areas. Our roll-off containers give you a convenient, centralized place to load all your waste — then we transport it to a licensed disposal facility.
                            </p>
                            <p style={{ color: 'var(--color-gray-600)', marginTop: '1rem' }}>
                                Whether you're a homeowner dealing with renovation waste, a contractor managing project disposal, or a property manager clearing out a rental — our roll-off dumpster service is the most cost-effective waste disposal solution in Clinton.
                            </p>
                            <p style={{ color: 'var(--color-gray-600)', marginTop: '1rem' }}>
            ...
            <section style={{ background: 'var(--color-primary)', color: 'white', padding: 'var(--spacing-2xl) 0', textAlign: 'center' }}>
                <div className="container">
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <TrackedPhoneLink location="Waste Disposal Clinton CTA" className="btn btn-outline-white btn-lg">Call 601-316-7891</TrackedPhoneLink>
                    </div>
                </div>
            </section>
        </>
