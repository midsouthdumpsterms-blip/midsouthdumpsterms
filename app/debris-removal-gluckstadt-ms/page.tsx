...
export const metadata: Metadata = {
    alternates: { canonical: 'https://midsouthdumpsterms.com/debris-removal-gluckstadt-ms' },
    title: 'Debris Removal Gluckstadt MS | Roll-Off Dumpster Service | Mid South',
    description: 'Debris removal in Gluckstadt, MS — rent a roll-off dumpster and we haul away your construction debris, renovation waste, storm damage, and yard debris. Same-day delivery. Call 601-316-7891.',
    openGraph: {
        title: 'Debris Removal Gluckstadt MS | Mid South Dumpster Rentals',
        description: 'Fast debris removal in Gluckstadt, MS. Roll-off dumpsters for construction debris, storm cleanup, renovation waste and yard debris. Same-day delivery.',
        url: 'https://midsouthdumpsterms.com/debris-removal-gluckstadt-ms',
    },
}

export default function DebrisRemovalGluckstadtPage() {
    const serviceSchema = generateServiceSchema('Debris Removal', 'Debris removal service in Gluckstadt, MS via roll-off dumpster rental. We deliver a container, you fill it, we haul it away.', 'Gluckstadt, MS')
    const breadcrumbSchema = generateBreadcrumbSchema([
        { name: 'Home', url: 'https://midsouthdumpsterms.com' },
        { name: 'Debris Removal Gluckstadt MS', url: 'https://midsouthdumpsterms.com/debris-removal-gluckstadt-ms' },
    ])
        ...
        <>
            ...
            <section style={{ background: 'linear-gradient(135deg, var(--color-primary) 0%, var(--color-secondary) 100%)', color: 'white', padding: '4rem 0', textAlign: 'center' }}>
                <div className="container">
                    <h1 style={{ color: 'white', fontSize: '2.25rem', marginBottom: '1rem' }}>Debris Removal in Gluckstadt, MS</h1>
                    <p style={{ fontSize: '1.2rem', opacity: 0.92, maxWidth: '640px', margin: '0 auto 2rem' }}>
                        The easiest way to remove debris in Gluckstadt — we deliver a roll-off dumpster, you fill it, we haul it all away
                    </p>
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        <BookingButton label="Book Online" location="Debris Removal Gluckstadt Hero" />
                        <TrackedPhoneLink location="Debris Removal Gluckstadt Hero" className="btn btn-outline-white btn-lg">Call 601-316-7891</TrackedPhoneLink>
                    </div>
                </div>
            </section>
            ...
            <section style={{ padding: 'var(--spacing-2xl) 0' }}>
                <div className="container">
                    <div className="grid grid-2">
                        <div>
                            <h2>Debris Removal in Gluckstadt, Mississippi</h2>
                            <p style={{ color: 'var(--color-gray-600)' }}>
                                Mid South Dumpster Rentals provides debris removal throughout Gluckstadt, MS using roll-off dumpster containers. We serve all of Gluckstadt including Gluckstadt, Old Canton Road, and Highway 51. We drop off the dumpster, you load it on your schedule, and we pick it up and dispose of everything responsibly.
                            </p>
                            <p style={{ color: 'var(--color-gray-600)', marginTop: '1rem' }}>
                                We handle all types of debris removal in Gluckstadt — construction and demolition debris, storm damage, renovation waste, yard debris, and household cleanout material. Same-day delivery is often available.
                            </p>
                        </div>
                        <div>
            ...
            <section style={{ background: 'var(--color-gray-50)', padding: 'var(--spacing-2xl) 0' }}>
                <div className="container">
                    <h2 className="text-center">Debris Removal Pricing in Gluckstadt, MS</h2>
            ...
            <section style={{ padding: 'var(--spacing-2xl) 0' }}>
                <div className="container">
                    <p style={{ color: 'var(--color-gray-600)' }}>
                        Gluckstadt is located in <Link href="/service-areas/madison-county" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}></Link>. Also see our <Link href="/service-areas/gluckstadt" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}> dumpster rental page</Link> and <Link href="/waste-disposal-gluckstadt-ms" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}>waste disposal in Gluckstadt</Link>.
                    </p>
            ...
            <section style={{ background: 'var(--color-primary)', color: 'white', padding: 'var(--spacing-2xl) 0', textAlign: 'center' }}>
                <div className="container">
                    <h2 style={{ color: 'white' }}>Ready for Debris Removal in Gluckstadt?</h2>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        <BookingButton label="Book Now Online" location="Debris Gluckstadt CTA" />
                        <TrackedPhoneLink location="Debris Gluckstadt CTA" className="btn btn-outline-white btn-lg">Call 601-316-7891</TrackedPhoneLink>
                    </div>
                </div>
            </section>
        </>
